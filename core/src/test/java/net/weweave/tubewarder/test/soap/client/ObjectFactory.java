...
public class ObjectFactory {
    ...
    private final static QName _SoapSendModel_QNAME = new QName("http://soap.service.tubewarder.weweave.net/", "soapSendModel");
    ...
    /**
     * Create an instance of {@link SoapSendModel }
     * 
     */
    public SoapSendModel createSoapSendModel() {
        return new SoapSendModel();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SoapSendModel }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://soap.service.tubewarder.weweave.net/", name = "soapSendModel")
    public JAXBElement<SoapSendModel> createSoapSendModel(SoapSendModel value) {
        return new JAXBElement<SoapSendModel>(_SoapSendModel_QNAME, SoapSendModel.class, null, value);
    }
