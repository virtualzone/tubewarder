...
@RequestScoped
@Path("/outputhandlerconfiguration/delete")
public class DeleteOutputHandlerConfigurationService extends AbstractService {
    @Inject
    private AbstractOutputHandlerConfigurationDao outputHandlerConfigurationDao;
    ...
    private void deleteObject(String id) throws ObjectNotFoundException {
        AbstractOutputHandlerConfiguration config = getOutputHandlerConfigurationDao().get(id);
        getOutputHandlerConfigurationDao().delete(config);
    }

    public AbstractOutputHandlerConfigurationDao getOutputHandlerConfigurationDao() {
        return outputHandlerConfigurationDao;
    }

    public void setOutputHandlerConfigurationDao(AbstractOutputHandlerConfigurationDao outputHandlerConfigurationDao) {
        this.outputHandlerConfigurationDao = outputHandlerConfigurationDao;
    }
}
